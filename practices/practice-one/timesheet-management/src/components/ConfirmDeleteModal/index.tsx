...
const ConfirmDeleteModal = ({ id, onDelete, onCloseConfirmModal }: IConfirmModal): React.ReactElement => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
      <div className="bg-white py-5 rounded w-2/5 flex flex-col justify-center items-center ">
        ...
        <div>
          ...
          <Button size="sm" bgColor="primary" textContent="Confirm" onClick={() => onDelete(id)} />
        </div>
      </div>
    </div>
  );
